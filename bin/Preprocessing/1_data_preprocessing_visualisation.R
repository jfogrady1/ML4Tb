...
rownames(ogrady_covariate) <- ogrady_covariate$Sample
rownames(ogrady_data_raw) <- ogrady_data_raw$Geneid
ogrady_data_raw <- ogrady_data_raw %>% select(-1)

dds_ogrady_full <- DESeqDataSetFromMatrix(countData = ogrady_data_raw, 
                                               colData = ogrady_covariate, 
...
dds_ogrady_full_pca_data <- plotPCA(dds_ogrady_full_vst, intgroup=c("Condition"), ntop = 750, returnData=TRUE)
percentVar <- round(100 * attr(dds_ogrady_full_pca_data, "percentVar"))
percentVar
ogrady_all_samples_ggplot <- ggplot(dds_ogrady_full_pca_data, aes(PC1, PC2, color=Condition)) +
  geom_point(size=4) +
...
wiarda_covariate <- wiarda_covariate %>% mutate(Status = if_else(Week == "W0", "Control", Status))
wiarda_covariate
...
dds_wiarda_full_pca_data <- plotPCA(dds_wiarda_full_vst, intgroup=c("Status", "Week"), ntop = 750, returnData=TRUE)
...
dds_wiarda_full_pca_data_W0 <- plotPCA(dds_wiarda_full_vst[,dds_wiarda_full_vst$Week == "W0"], intgroup=c("Status"), ntop = 750, returnData=TRUE)
...
dds_wiarda_full_pca_data_W4 <- plotPCA(dds_wiarda_full_vst[,dds_wiarda_full_vst$Week == "W4"], intgroup=c("Status"), ntop = 750, returnData=TRUE)
...
dds_wiarda_full_pca_data_W10 <- plotPCA(dds_wiarda_full_vst[,dds_wiarda_full_vst$Week == "W10"], intgroup=c("Status"), ntop = 750, returnData=TRUE)
...
dds_kirsten_full_pca_data <- plotPCA(dds_kirsten_full_vst, intgroup=c("Status", "Week"), ntop = 750, returnData=TRUE)
...
kirsten_all_samples_ggplot <- ggplot(dds_kirsten_full_pca_data, aes(PC1, PC2, color=Status, shape=Week)) +
  ...
  xlab(paste0("PC1: ",percentVar[1],"% variance")) +
  ylab(paste0("PC2: ",percentVar[2],"% variance")) + 
  coord_fixed(xlim = c(-30, 30), ylim = c(-35,35)) + scale_colour_manual(labels = c("Control", "Infected"), values = c("#386cb0", "#662506")) + theme_Publication() + ggtitle("All samples")



dds_kirsten_full_pca_data_W1 <- plotPCA(dds_kirsten_full_vst[,dds_kirsten_full_vst$Week %in% c("W-1","W1")], intgroup=c("Status"), ntop = 750, returnData=TRUE)
...
kirsten_W1_samples_ggplot <- ggplot(dds_kirsten_full_pca_data_W1, aes(PC1, PC2, color=Status)) +
  ...
  xlab(paste0("PC1: ",percentVar[1],"% variance")) +
  ylab(paste0("PC2: ",percentVar[2],"% variance")) + 
  coord_fixed(xlim = c(-30, 30), ylim = c(-35,35)) + scale_colour_manual(labels = c("Control", "Infected"), values = c("#386cb0", "#662506")) + theme_Publication() + ggtitle("Week 1")
kirsten_W1_samples_ggplot

dds_kirsten_full_pca_data_W2 <- plotPCA(dds_kirsten_full_vst[,dds_kirsten_full_vst$Week %in% c("W-1","W2")], intgroup=c("Status"), ntop = 750, returnData=TRUE)
...
kirsten_W2_samples_ggplot <- ggplot(dds_kirsten_full_pca_data_W2, aes(PC1, PC2, color=Status)) +
  ...
  xlab(paste0("PC1: ",percentVar[1],"% variance")) +
  ylab(paste0("PC2: ",percentVar[2],"% variance")) + 
  coord_fixed(xlim = c(-30, 30), ylim = c(-35,35)) + scale_colour_manual(labels = c("Control", "Infected"), values = c("#386cb0", "#662506")) + theme_Publication() + ggtitle("Week 2")


dds_kirsten_full_pca_data_W6 <- plotPCA(dds_kirsten_full_vst[,dds_kirsten_full_vst$Week %in% c("W-1","W6")], intgroup=c("Status"), ntop = 750, returnData=TRUE)
...
kirsten_W6_samples_ggplot <- ggplot(dds_kirsten_full_pca_data_W6, aes(PC1, PC2, color=Status)) +
  ...
  xlab(paste0("PC1: ",percentVar[1],"% variance")) +
  ylab(paste0("PC2: ",percentVar[2],"% variance")) + 
  coord_fixed(xlim = c(-30, 30), ylim = c(-35,35)) + scale_colour_manual(labels = c("Control", "Infected"), values = c("#386cb0", "#662506")) + theme_Publication() + ggtitle("Week 6")




dds_kirsten_full_pca_data_W10 <- plotPCA(dds_kirsten_full_vst[,dds_kirsten_full_vst$Week %in% c("W-1","W10")], intgroup=c("Status"), ntop = 750, returnData=TRUE)
...
kirsten_W10_samples_ggplot <- ggplot(dds_kirsten_full_pca_data_W10, aes(PC1, PC2, color=Status)) +
  ...
  xlab(paste0("PC1: ",percentVar[1],"% variance")) +
  ylab(paste0("PC2: ",percentVar[2],"% variance")) + 
  coord_fixed(xlim = c(-30, 30), ylim = c(-35,35)) + scale_colour_manual(labels = c("Control", "Infected"), values = c("#386cb0", "#662506")) + theme_Publication() + ggtitle("Week 10")




dds_kirsten_full_pca_data_W12 <- plotPCA(dds_kirsten_full_vst[,dds_kirsten_full_vst$Week %in% c("W-1","W12")], intgroup=c("Status"), ntop = 750, returnData=TRUE)
...
kirsten_W12_samples_ggplot <- ggplot(dds_kirsten_full_pca_data_W12, aes(PC1, PC2, color=Status)) +
  ...
  xlab(paste0("PC1: ",percentVar[1],"% variance")) +
  ylab(paste0("PC2: ",percentVar[2],"% variance"))  + 
  coord_fixed(xlim = c(-30, 30), ylim = c(-35,35)) +scale_colour_manual(labels = c("Control", "Infected"), values = c("#386cb0", "#662506")) + theme_Publication() + ggtitle("Week 12")
...
dds_kirsten_pbl_full_pca_data <- plotPCA(dds_kirsten_pbl_full_vst, intgroup=c("Status"), ntop = 750, returnData=TRUE)
